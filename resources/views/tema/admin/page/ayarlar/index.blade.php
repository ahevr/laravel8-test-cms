        ...
        <div class="card card-custom gutter-b">
            <div class="card-header">
                ...
                <div class="card-toolbar">
                    <a href="{{route("admin.ayarlar.ekleForm")}}" class="btn btn-primary font-weight-bolder">
                    ...
                    <div class="example-preview">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <th scope="col">Site Açıklaması</th>
                            ...
                            @foreach($data as $row)
                                <tr>
                                    ...
                                    <td>{{$row->telefon}}</td>
                                    <td>
                                        <a href="{{route("admin.ayarlar.duzenleForm",$row->id)}}"
